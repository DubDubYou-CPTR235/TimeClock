...
class TimeCardsControllerTest < ActionController::TestCase
  ...
  test "should create time_card" do
    assert_difference('TimeCard.count') do
      post :create, time_card: { clocked_in: @time_card.clocked_in, task_id: @time_card.task_id, user_id: @time_card.user_id }
    end
  ...
  test "should update time_card" do
    patch :update, id: @time_card, time_card: { clocked_in: @time_card.clocked_in, task_id: @time_card.task_id, user_id: @time_card.user_id }
    assert_redirected_to time_card_path(assigns(:time_card))
  end
